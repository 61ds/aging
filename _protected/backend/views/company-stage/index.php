...
/* @var $searchModel common\models\CompanyStageSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Startup Company Stages';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="company-stage-index">
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body table-responsive">
                    ...
                    <p>
                        <?= Html::a('Create Company Stage', ['create'], ['class' => 'btn btn-success']) ?>
                    </p>
