...
/* @var $searchModel common\models\CompanyCapitalSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Company Capitals';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="company-capital-index">
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body table-responsive">
                    <p>
                        <?= Html::a('Create Company Capital', ['create'], ['class' => 'btn btn-success']) ?>
                    </p>
