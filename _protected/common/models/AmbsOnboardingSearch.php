...
/**
 * AmbsOnboardingSearch represents the model behind the search form about `common\models\AmbsOnboarding`.
 */
class AmbsOnboardingSearch extends AmbsOnboarding
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'country_code', 'area_code', 'phone_number', 'chapter', 'chapter_city', 'chapter_state', 'chapter_country', 'address_city', 'address_state', 'address_country', 'address_zip', 'preferred_payment', 'bank_city', 'bank_state', 'bank_country', 'bank_zip'], 'integer'],
