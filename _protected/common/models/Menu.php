...
class Menu extends \kartik\tree\models\Tree
{
    ...
    public function rules()
    {
        return [
            ...
            [['menu_type', 'root', 'lft', 'rgt', 'lvl', 'icon_type',  'selected', 'disabled', 'readonly', 'visible', 'collapsed', 'movable_u', 'movable_d', 'movable_l', 'movable_r', 'removable', 'removable_all'], 'integer'],
